...
const SpeechOutput: React.FC<SpeechOutputProps> = ({ content }) => {
  ...
  // Remove the section headers like "### **Mở đầu**" to create a single, seamless speech.
  // The AI is still instructed to use these headers for structure, but we remove them for the final presentation.
  const cleanedContent = content
    .replace(/### \*\*(Mở đầu|Thân bài|Kết luận)\*\*/g, '')
    .trim();
  ...
  const handleCopy = () => {
    ...
    const plainTextContent = stripMarkdown(cleanedContent);
